...
class Document(Base):
    ...
    doc_type: Mapped[str] = mapped_column(
        ...
        default='report', nullable=False,
    )
    status: Mapped[str] = mapped_column(
        SAEnum('draft', 'checked', 'optimized', 'unfilled', 'filled', 'archived',
...
class DocumentVersion(Base):
    ...
    change_type: Mapped[str | None] = mapped_column(
        SAEnum('draft', 'check', 'optimize', name='doc_process_type', create_type=False),
    )
